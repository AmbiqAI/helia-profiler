...
```csv
layer_idx,layer_id,op_type,op_name,tensor_role,tensor_name,tensor_kind,memory,source_memory,staged,arena_role,arena_region_id,offset,size
0,0,CONV_2D,conv_2d_0,local,tensor_17,constant,dtcm,dtcm,False,constant,1,0,2560
```
