...
- By default, generated profiler apps keep the board's normal NSX `channel`, but HPX pins the verified peeled commits for `neuralspotx-v0.8.1` (`2dbe12a2…901f`) and `nsx-ambiq-sdk` v5.2.24 (`a9f4ec25…1132`) in the qualified compatibility baseline.
