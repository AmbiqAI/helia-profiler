...
- By default, generated profiler apps keep the board's normal NSX `channel`, but HPX pins the verified peeled commits for `neuralspotx-v0.8.0` (`38aff779…9490`) and `nsx-ambiq-sdk` v5.2.25 (`aefce2ca…de7c`) in the qualified compatibility baseline.
