...
class TestNsxModuleParsing:
    ...
    def test_valid_path(self):
        ...
        """
        r = _run_hpx("--nsx-module", "nsx-ambiq-bsp-r5:path=/tmp/bsp")
    ...
    def test_valid_ref(self):
        ...
        r = _run_hpx("--nsx-module", "nsx-ambiq-hal-r5:ref=feat/new-soc")
        assert "NAME:KEY=VALUE" not in r.stderr

    def test_valid_version(self):
        """Valid --nsx-module version=... should not fail at parse time."""
        r = _run_hpx("--nsx-module", "nsx-ambiqsuite-r5:version=2.0.0")
        assert "NAME:KEY=VALUE" not in r.stderr
