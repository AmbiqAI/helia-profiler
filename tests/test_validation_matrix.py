...
class TestBuildMatrix:
    def test_full_matrix_default(self):
        ...
        # Existing engines contribute 3420 cases across the five boards.
        # ExecuTorch adds 256 cases on each Cortex-M55 board: 4 models × 2
