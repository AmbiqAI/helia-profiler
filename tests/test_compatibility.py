...
def test_default_baseline_has_exact_qualified_refs(tmp_path: Path) -> None:
    ...
    assert baseline.project("nsx-executorch").ref == "4a257def0c3ebd4ecd6a5d412f087d297f1b3492"
    assert baseline.engine("executorch").ref == "4a257def0c3ebd4ecd6a5d412f087d297f1b3492"
...
def test_baseline_has_no_unrelated_ref_drift() -> None:
    ...
    assert {project.name: project.ref for project in baseline.projects} == {
        ...
        "nsx-executorch": "4a257def0c3ebd4ecd6a5d412f087d297f1b3492",
