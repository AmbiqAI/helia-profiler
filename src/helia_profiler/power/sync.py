...
JS220 wire it to GPI/GPO, while JS320 supports gate-only capture through GPI.
A UART-only or another instrument can implement the same protocol. The matching
firmware side lives in the ``_sync.j2`` macros.
"""
