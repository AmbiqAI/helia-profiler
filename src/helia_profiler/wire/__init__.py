...
bytes are frozen this phase). #163's documented gaps were closed by #165 —
...
reports the summed runtime workspace (planned + method + temporary arenas), so
the figure is comparable with TFLM's single-arena number:
