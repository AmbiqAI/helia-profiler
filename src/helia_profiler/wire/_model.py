...
EST_MS_GAP = (
    ...
    "Every transport (RTT/SWO/UART/USB CDC, via collect_lines) holds an "
    "announced budget as a floor on its inactivity deadline until it "
    "expires, never past the overall capture deadline. The budget comes "
    "from window_budget_s, capped at WINDOW_BUDGET_CAP_S. A "
