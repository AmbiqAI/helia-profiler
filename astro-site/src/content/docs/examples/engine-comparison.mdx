...
description: "Goal: run the same model through heliaRT and heliaAOT to compare binary size, cycles, and memory usage."
---
...
[Toolchain Comparison](../toolchain-comparison/) if you also want to vary
the compiler.
:::

## Where to go deeper

- [Inference Engines](../../guide/engines/) — heliaRT vs. heliaAOT trade-offs.
- [Output & Results](../../guide/output/) — every `summary.json` field.
- [Memory Placement](../../guide/memory/) — why arena/weights usage differs
  between engines.
