...
description: "Goal: profile a TFLite model with default settings to get total cycle counts and a per-layer breakdown."
---
...
- [Configuration](../../guide/configuration/) — full YAML schema and CLI merge rules.
- [Output & Results](../../guide/output/) — every result file and field.
- [Per-Layer Breakdown](../per-layer/) — capture more PMU counters per layer.
