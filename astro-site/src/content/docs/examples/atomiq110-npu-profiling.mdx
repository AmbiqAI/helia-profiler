---
title: "Atomiq110 NPU Profiling (Ethos-U85, Experimental)"
description: "Goal: profile a Vela-compiled model on the Ethos-U85 NPU on atomiq110fpgaturbo, capturing both ARM PMU counters and the NPU's own PMU (ethosnpu group) per…"
---
...
- [Configuration Reference](../../reference/configuration/) — `pmu_counters`
