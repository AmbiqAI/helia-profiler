...
description: "Use heliaPROFILER as a Python library when you want to explore a model interactively, retain typed results, or branch one experiment into several…"
---
...
[<Icon name="book" /> Walkthrough](https://github.com/AmbiqAI/helia-profiler/blob/main/examples/notebooks/hpx_walkthrough.ipynb)
...
[Interactive sessions](../../reference/api/session/).
