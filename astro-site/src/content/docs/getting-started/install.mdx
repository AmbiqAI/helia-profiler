---
title: "Installation"
description: "heliaPROFILER (hpx) needs Python plus a small set of embedded-development tools: an ARM cross-compiler, CMake/Ninja, and SEGGER J-Link software. Power capture…"
---
...
[Toolchains](../../guide/toolchains/). A Joulescope JS110/JS220/JS320 is optional
and only needed for power capture — see [Power Measurement](../../guide/power/).
...
See [Power Measurement](../../guide/power/) for wiring and sync-GPIO setup.
