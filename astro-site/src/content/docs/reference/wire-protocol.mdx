---
title: "Wire protocol"
description: "This page is the contract between the profiler firmware hpx generates and the host that reads it. It is not a user API: nothing here is called from YAML, the…"
---
