---
title: "Wire protocol"
description: "This page is the contract between the profiler firmware hpx generates and the host that reads it. It is not a user API: no line here is something you invoke,…"
---
