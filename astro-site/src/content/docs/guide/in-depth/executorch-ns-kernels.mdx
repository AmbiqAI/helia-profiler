---
title: "ExecuTorch NS Tier-1 Kernels"
description: "ExecuTorch PTEs exported for Cortex-M can be lowered against two CMSIS-NN providers. The arm provider uses upstream arm-cmsis-nn and leaves ops outside the…"
---
...
[Inference Engines](../../engines/#ns-tier-1-kernels-ns_ops) for how to
