---
title: "Memory Placement Tuning"
description: "You've got a model profiling cleanly with default auto placement, and now you want to know: is auto making the best choice, and can you shrink the arena…"
---
...
differences), see [Memory Placement](../../memory/) — this guide is
...
[output guide](../../output/#planned-vs-measured-memory)) and
...
one. See [The memory tiers](../../memory/#the-memory-tiers) for the
...
- [Memory Placement](../../memory/) — tiers, `auto`'s algorithm,
  worked examples, and engine-specific placement (heliaAOT per-tensor
  attributes).
- [`hpx profile` reference](../../../reference/profile/) — every placement
  flag.
- [Output & Results](../../output/) — the full `summary.json` schema.
