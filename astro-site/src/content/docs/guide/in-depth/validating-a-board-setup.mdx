---
title: "Validating a Board Setup"
description: "You've wired up a new EVB (or a bench you haven't touched in a while) and before you trust any profiling numbers off it, you want proof the whole chain —…"
---
...
- [Boards & Platforms](../../boards/) — board IDs and per-board
