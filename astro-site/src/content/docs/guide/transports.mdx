...
description: "heliaPROFILER supports four ways to get profiling data off the target. The transport affects reliability, throughput, and what hardware you need plugged in.…"
---
...
[Dedicated power firmware](../power/#dedicated-power-firmware)), power
...
:::caution[RTT capture hangs / no data after flash]
