---
title: "Analysis and Run Comparison"
description: "Profiling answers what happened on a board. Two related workflows help before and after that measurement:"
---
...
starting a firmware build. See the [`hpx analyze` reference](../../reference/analyze/)
for every option.
...
the [`hpx compare` reference](../../reference/compare/) for the full contract.
