...
description: "Where you place the tensor arena (activations / scratch space) and the model weights (the .tflite flatbuffer or AOT weight blobs) often matters more than the…"
---
...
* [`hpx profile` reference](../../reference/profile/) — full CLI flags
* [Boards and SoCs](../boards/) — per-SoC memory capacities
* [Engines](../engines/) — heliaRT vs heliaAOT trade-offs
