---
title: "Data Capture"
description: "The capture subsystem collects PMU counter data from the target MCU over the configured transport — RTT by default, with USB CDC, UART, and SWO as alternatives…"
---
...
alternatives (see [Capture Transports](../../transports/)) — and
