---
title: "Field-diagnostics support bundle"
description: "hpx doctor --bundle exists so a customer or field engineer can hand a maintainer one sanitized archive instead of a screen-share, without either side worrying…"
---
