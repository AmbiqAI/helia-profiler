...
description: "This section is for contributors, developers, and AI agents working on heliaPROFILER internals. It covers the design philosophy, system architecture, and…"
---
...
- [Compatibility Baseline](../../architecture/compatibility-baseline/) — the qualified NSX project/module/engine baseline
- [Pipeline & Stages](../../architecture/pipeline/) — detailed stage-by-stage walkthrough
- [Engine Adapters](../../architecture/engine-adapters/) — how engines wire into the pipeline
- [Firmware Generation](../../architecture/firmware/) — templates, NSX modules, build process
- [Data Capture](../../architecture/capture/) — HPX protocol, transports, parsing, multi-pass merging
- [Field Diagnostics](../../architecture/field-diagnostics/) — redaction and the `hpx doctor --bundle` support bundle
- [Contributing an Engine](../../architecture/adding-an-engine/) — step-by-step guide
