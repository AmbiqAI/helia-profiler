...
description: "The engine adapter layer decouples the profiling pipeline from specific inference frameworks. Each engine implements the same EngineAdapter protocol, letting…"
---
...
1. Resolves the `nsx-executorch` checkout: by default it auto-clones the
   ...
   [compatibility baseline](../../../architecture/compatibility-baseline/), including its
...
[Firmware Generation](../../../architecture/firmware/)); the adapter appends its
