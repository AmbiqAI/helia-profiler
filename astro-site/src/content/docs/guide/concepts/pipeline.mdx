...
description: "The profiling pipeline is a flat, ordered sequence of stages. Each stage reads from the shared PipelineContext and writes its outputs back."
---
...
See [Output & Results](../../output/) for file format details.
