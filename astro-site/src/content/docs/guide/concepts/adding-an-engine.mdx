...
description: "This guide walks through adding a new inference engine to heliaPROFILER. By the end, hpx profile --engine your-engine will build, flash, and profile firmware…"
---
...
- Familiarity with the [Engine Adapters](../../../architecture/engine-adapters/) architecture
...
The parser depends on this protocol. See [Data Capture](../../../architecture/capture/) for the
...
Add a section to [Engines](../../engines/) describing:
