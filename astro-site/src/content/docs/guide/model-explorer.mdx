...
description: "heliaPROFILER exports per-layer profiling metrics as JSON overlays compatible with Model Explorer. This lets you visually inspect which operators are hot spots."
---
