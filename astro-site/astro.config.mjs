          ...
          sections: [
            { label: 'Home', href: basePath, sidebar: false },
            {
              ...
              sidebar: [
                ...
                { label: 'Next steps', slug: 'getting-started/where-next' },
              ],
            },
            {
              label: 'User guide',
              ...
              sidebar: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { label: 'Measurement windows', slug: 'guide/power-windows' },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { label: 'Inference and layer timing', slug: 'guide/latency' },
                    { label: 'Compare results', slug: 'guide/analysis-comparison' },
            ...
            },
            {
              ...
              sidebar: [
                ...
                { label: 'Capture per-layer counters', slug: 'examples/per-layer' },
